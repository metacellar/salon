...
** Types and Categorys
   ...
   #+begin_src dot :file img/int_bool.png :cmdline -Tpng :export results :cache yes
    digraph G {
      size="2,2"
      Int -> Bool
    }
...
*** Isomorphism
    ...
    #+begin_src dot :file img/isomorphism.png :cmdline -Tpng :export results :cache yes
     digraph G {
       size="4,4"
       rankdir="LR"
       a -> b [label="f"]
...
**** Initial Object
     ...
     #+begin_src dot :file img/initial.png :cmdline -Tpng :export results :cache yes
      digraph G {
        size="8,6"
        rankdir="BT"
        InitialObject -> a
...
**** Terminal Object
     ...
     #+begin_src dot :file img/terminal.png :cmdline -Tpng :export results :cache yes
      digraph G {
        size="8,6"
        rankdir="BT"
        a -> b
...
**** Product
     ...
     #+begin_src dot :file img/cartisian_product.png :cmdline -Tpng :export results :cache yes
      digraph G {
        size="4,4"
        rankdir="TB"
        c -> a [label="p"]
     ...
     #+begin_src dot :file img/mutiple_product.png :cmdline -Tpng :export results :cache yes
      digraph G {
        size="4,4"
        rankdir="TB"
        c1 -> a
     ...
     #+begin_src dot :file img/product.png :cmdline -Tpng :export results :cache yes
      digraph G {
        size="4,4"
        rankdir="TB"
        cprimer[label="c'"]
...
**** Coproduct
     ...
     #+begin_src dot :file img/coproduct.png :cmdline -Tpng :export results :cache yes
      digraph G {
        size="4,4"
        rankdir="TB"
        cprimer[label="c'"]
